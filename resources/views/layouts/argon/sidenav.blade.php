<aside
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700"
           href="https://demos.creative-tim.com/argon-dashboard-tailwind/pages/dashboard.html" target="_blank">
            ...
            <img src="./assets/img/logo-ct.png"
                 ...
                 alt="main_logo"/>
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">RERP</span>
        </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
                        ...
                        <a class="{{ isset($sidebar['link']) && (Route::currentRouteName() == $sidebar['link']) ? 'bg-blue-500/10':'' }} py-2.7 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                           href="{{ $sidebar['link'] }}">
                            <div
                                ...
                                <i class="relative top-0 text-sm leading-normal {{ $sidebar['icon-color'] }} {{ $sidebar['icon'] }}"></i>
                            </div>
                ...
                <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="./pages/billing.html">
                    <div
                        ...
                        <i class="relative top-0 text-sm leading-normal text-emerald-500 fa-solid fa-money-bill"></i>
                    </div>
            ...
            <li class="w-full mt-4">
                <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">Accountaa
                    pages</h6>
            </li>
